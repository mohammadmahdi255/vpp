...
#undef _
	...
	CLIB_MARCH_FN_SELECT(set_next_node)(nexts, frame->n_vectors);
...
CLIB_MARCH_FN (ethernet_detunnel_simd_init, void, void)
{
...
#undef _
	...
	CLIB_MARCH_FN_SELECT (ethernet_detunnel_simd_init) ();
